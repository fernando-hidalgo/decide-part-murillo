...
class BoothPreferenceView(TemplateView):
    template_name = "booth/boothPreference.html"
...
class BoothMultiChoiceView(TemplateView):
    template_name = "booth/boothMultiChoice.html"
