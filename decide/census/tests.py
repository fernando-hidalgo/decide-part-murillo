...
from .admin import CensusAdmin, CensusByPreferenceAdmin, CensusYesNoAdmin
...
class CensusImportViewTest(BaseTestCase):
    ...
    def test_census_import_view(self):
        ...
        sheet.append(["Voting ID", "Voter ID", "Grupo"])
        ...
        expected_messages = [
            "Ya existe un registro para la pareja de voting_id=1, voter_id=1 y grupo=Test Group",
